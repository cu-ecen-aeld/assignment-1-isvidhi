...
void test_validate_my_username()
{
    ...
    const char *uname_from_conf = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(uname, uname_from_conf, "AESD students, please fix me!");
    free((void *)uname_from_conf);
}
